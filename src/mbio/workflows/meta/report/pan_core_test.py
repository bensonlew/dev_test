...
class PanCoreTestWorkflow(Workflow):
    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        super(PanCoreTestWorkflow, self).__init__(wsheet_object)
        options = [
        ...
        self.pan_core = self.add_tool("meta.otu.pan_core_otu_test")
    ...
    def run(self):
        self.run_pan_core()
        super(PanCoreTestWorkflow, self).run()
    ...
    def end(self):
        ...
        super(PanCoreTestWorkflow, self).end()
