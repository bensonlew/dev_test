...
dev.off()
write.table(tempplot$sites, '%s/db_rda_sites.temp.txt', sep = '\\t', col.names = NA, quote = FALSE)
write.table(tempplot$biplot, '%s/db_rda_factor.temp.txt', sep = '\\t', col.names = NA, quote = FALSE)
