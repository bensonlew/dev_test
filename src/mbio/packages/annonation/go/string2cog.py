...
# test = string2cog()
# test.string2cog_by_sqlite(string_xml='/mnt/ilustre/users/sanger-dev/sg-users/hesheng/test/test_file/blast_result/Trinity_vs_string.xml', out_dir='/mnt/ilustre/users/sanger-dev/sg-users/qiuping/denovo/test/annotation/result_files/cog')
