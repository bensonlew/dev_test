...
class SoapAlignerTool(Tool):
    def __init__(self, config):
        ...
        self.index = self.option("index").prop['path'] + '/' + 'gene.uniGeneset.fa.index'
    ...
    def pair_map(self):
        ...
        if command1.return_code == 0:
            ...
            self.set_error("pair_map failed")
    ...
    def single_map(self):
        ...
        if command2.return_code == 0:
            ...
            self.set_error("single_map failed")
