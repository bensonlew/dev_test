...
class BowtieIndexTool(Tool):
    def __init__(self, config):
        ...
        self.cmd_path_dic = {"bowtie1": "bioinfo/rna/MapSplice-v2.1.8/bin/",
                             "bowtie2": "bioinfo/rna/align/bowtie2-2.2.9/"}
    ...
    def run_bowtie_index(self):
        ...
        cmd = "{}bowtie-build  {}  {}/{}".format(self.cmd_path_dic[self.option('bowtie_version')],
