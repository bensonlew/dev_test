...
from mbio.tools.ref_rna.express.diff_exp_zp.ballgown_expr_zp import *
import os
import re


class SampleClusterBallgownAgent(Agent):
    """
    ...
    def __init__(self, parent):
        super(SampleClusterBallgownAgent, self).__init__(parent)
        options = [
    ...
    def end(self):
        ...
        super(SampleClusterBallgownAgent, self).end()


class SampleClusterBallgownTool(Tool):
    """
    表达量差异检测tool
    """
    def __init__(self, config):
        super(SampleClusterBallgownTool, self).__init__(config)
        self._version = '1.0.1'
    ...
    def run_cluster(self):
        ...
        clust_cmd = self.r_path + " ballgown_expr"
    ...
    def run(self):
        super(SampleClusterBallgownTool, self).run()
        self.run_cluster()
        self.set_output()
        self.end()
