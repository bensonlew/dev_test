...
def stat_DESeq2(edgr_result, countfile, fpkmfile, control, other, output, replicates=None, diff_ci=0.05, regulate=True):
    """对DESeq2结果进行统计，获得两两分组（或样本）的DESeq2统计文件以及差异基因列表文件"""
...
# stat_DESeq2( 'genes.counts.matrix.P7_1_vs_P7_2.DESeq2.DE_results','genes.counts.matrix', 'genes.TMM.EXPR.matrix', 'P1', 'P7', 'group.list.tmp', 0.05)
# stat_DESeq2('/mnt/ilustre/users/bingxu.liu/project/2014peixun/denovo8/diffexpression/replicates_DESeq2/unigene.counts.matrix.P1_vs_P7.DESeq2.DE_results', '/mnt/ilustre/users/bingxu.liu/project/2014peixun/denovo8/diffexpression/unigene.counts.matrix', '/mnt/ilustre/users/bingxu.liu/project/2014peixun/denovo8/diffexpression/unigene.TMM.fpkm.matrix', 'P1', 'P7', '../group.list.tmp')
