...
from mbio.tools.ref_rna.express.diff_exp_zp.sample_cluster_zp import *
import os
import re


class SampleClusterAgent(Agent):
    """
    ...
    def __init__(self, parent):
        super(SampleClusterAgent, self).__init__(parent)
        options = [
    ...
    def end(self):
        ...
        super(SampleClusterAgent, self).end()


class SampleClusterTool(Tool):
    """
    表达量差异检测tool
    """
    def __init__(self, config):
        super(SampleClusterTool, self).__init__(config)
        self._version = '1.0.1'
    ...
    def run_cluster(self):
        ...
        clust_cmd = self.r_path + " cluster_PCA_heatmap_cor"
    ...
    def run(self):
        super(SampleClusterTool, self).run()
        self.run_cluster()
        self.set_output()
        self.end()
