...
class CuffcompareAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "cuff.gtf", "type": "outfile", "format": "ref_rna.assembly.gtf"},  # compare后的combined.gtf文件
        ]
...
class CuffcompareTool(Tool):
    ...
    def run_cuffcompare(self):
        ...
        cmd = self.cuffcompare_path + 'cuffcompare -s {} -C -o {}cuffcmp -r {} {}'.format(
            ...
            self.option('merged.gtf').prop['path'])
    ...
    def set_output(self):
        ...
        try:
            ...
            self.option('cuff.gtf').set_path(self.work_dir + "/cuffcmp.combined.gtf")
