...
class SimpleBarTool(Tool):
    ...
    def set_output(self):
        ...
        shutil.copy2(self.work_dir + '/final_value.xls', self.output_dir + '/final_value.xls')   # 百分比表格
        shutil.copy2(self.work_dir + '/final_table.xls', self.output_dir + '/matrix_bar.xls')    # 丰度表格
