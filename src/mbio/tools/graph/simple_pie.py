    ...
    def set_output(self):
        ...
        if self.option("calculation") == "none":
            ...
            for i in range(len(self.option("group_table").prop['group_scheme'])):
                ...
                os.link(self.work_dir + '/' + self.option("group_table").prop['group_scheme'][i] + '/final_table.xls', self.output_dir + '/' + self.option("group_table").prop['group_scheme'][i] + '_matrix_pie.xls')
