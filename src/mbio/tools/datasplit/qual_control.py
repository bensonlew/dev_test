...
class QualControlTool(Tool):
    def __init__(self, config):
        ...
        self.javaPath = os.path.join(Config().SOFTWARE_DIR, "sun_jdk1.8.0/bin/java")
        self.trimmomaticPath = os.path.join(Config().SOFTWARE_DIR, "datasplit/bin/trimmomatic-0.36.jar")
