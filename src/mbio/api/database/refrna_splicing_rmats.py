...
class RefrnaSplicingRmats(Base):
    def __init__(self, bind_object):
        ...
        self._RMATS_DETAIL_TABLE_HEAD = ["event_id", "type", "novel", "old", "gene", "gene_symbol", "chr", "strand",
        ...
        self._RMATS_DETAIL_MONGO_TABLE_FIELD_DIC = {'event_id': 'event_id', 'type': 'type', 'novel_as': 'novel',
                                                    'gid': 'gene',
                                                    'gname': 'gene_symbol',
                                                    'chr': 'chr',
