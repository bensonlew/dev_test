...
class EnvironmentalRegression(MetaController):
    ...
    def POST(self):
        data = web.input()
        default_argu = ['otu_id', 'level_id', 'submit_location', 'group_detail', 'group_id', 'env_id', 'env_labs', 'horizontal']
        ...
        main_table_id = meta.insert_main_table('sg_environmental_regression', mongo_data)
