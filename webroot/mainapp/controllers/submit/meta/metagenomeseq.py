...
class Metagenomeseq(MetaController):
    def __init__(self):
        super(Metagenomeseq, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        main_table_id = meta.insert_main_table('sg_metagenomeseq', mongo_data)
        ...
        task_info = super(Metagenomeseq, self).POST()
