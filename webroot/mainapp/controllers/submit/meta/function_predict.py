...
class FunctionPredict(object):
    ...
    def POST(self):
        ...
        params_name = ['otu_id', 'submit_location']
        success = []
        print data
        ...
        if otu_info:
            ...
            update_info = {str(predict_id): "sg_16s_function_predict"}
            ...
            json_data = {
                ...
                "to_file": ["function_predict.export_otu_table(otu_table)", "function_predict.export_otu_rep(otu_reps)"],
                "USE_DB": True,
